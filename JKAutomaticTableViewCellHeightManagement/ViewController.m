...
- (void)viewDidLoad {
    ...
    _cellTitlesCollection = @[@"This is sample Label", @"This label title\nSpans two rows", @"This label\nSpans\nThree\nLines", @"This\nlabel\nSpans\nFour\nLines", @"This\nTitle\nSpans\nFive\nLines"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JKAutomaticTableHeightTableViewCell* cell = [tableView dequeueReusableCellWithIdentifier:cellIdentifier forIndexPath:indexPath];
